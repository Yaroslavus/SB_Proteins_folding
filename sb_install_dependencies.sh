...
sudo wget -q -P /content https://git.scicore.unibas.ch/schwede/openstructure/-/raw/\
...
sudo mkdir -p /content/alphafold/alphafold/common
sudo cp -f /content/stereo_chemical_props.txt /content/alphafold/alphafold/common
sudo mkdir -p /opt/conda/lib/python3.7/site-packages/alphafold/common/
sudo cp -f /content/stereo_chemical_props.txt /opt/conda/lib/python3.7/site-packages/alphafold/common/
